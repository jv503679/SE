...
#Test d'envoi/réception via le client
def test9():
    os.system("umask 000")
    ...
    if pid == 0 :
        time.sleep(3)
        os.system("xterm -e python cbot1.py localhost 2555 bot1 coucou salut")
    else :
        pid = os.fork()
        if pid == 0 :
            os.system("xterm -e python cbot2.py localhost 2555 bot2 coucou salut")
        else :
            time.sleep(10)
